!function (global, factory) {
    ...
    function _inherits(subClass, superClass) {
        ...
        }), Object.defineProperty(subClass, "prototype", {writable: !1}), superClass && _setPrototypeOf(subClass, superClass)
    }
   ...
   */
    ...
    var _default$6 = function () {
        ...
        })), FunctionPrototype$2 = Function.prototype, call$2 = FunctionPrototype$2.call,
        ...
        }, ceil = Math.ceil, floor = Math.floor, mathTrunc = Math.trunc || function (x) {
            var n = +x;
    ...
    var check = function (it) {
        ...
        global_1 = check("object" == typeof globalThis && globalThis) || check("object" == typeof window && window) || check("object" == typeof self && self) || check("object" == typeof commonjsGlobal && commonjsGlobal) || function () {
            return this
        }() || Function("return this")(), defineProperty$4 = Object.defineProperty,
        defineGlobalProperty = function (key, value) {
            try {
                defineProperty$4(global_1, key, {value: value, configurable: !0, writable: !0})
            } catch (error) {
                global_1[key] = value
            }
            return value
        }, SHARED = "__core-js_shared__", store$1 = global_1[SHARED] || defineGlobalProperty(SHARED, {}),
        sharedStore = store$1, shared = createCommonjsModule((function (module) {
        ...
        documentAll_1 = {all: documentAll$2, IS_HTMLDDA: IS_HTMLDDA}, documentAll$1 = documentAll_1.all,
        ...
        Deno$1 = global_1.Deno, versions = process$3 && process$3.versions || Deno$1 && Deno$1.version,
        v8 = versions && versions.v8, match, version;
    ...
    var engineV8Version = version, symbolConstructorDetection = !!Object.getOwnPropertySymbols && !fails((function () {
            var symbol = Symbol();
        ...
        WellKnownSymbolsStore = shared("wks"), Symbol$1 = global_1.Symbol, symbolFor = Symbol$1 && Symbol$1.for,
        ...
        }, TO_STRING_TAG$4 = wellKnownSymbol("toStringTag"), test = {};
    test[TO_STRING_TAG$4] = "z";
    var toStringTagSupport = "[object z]" === String(test), toString = functionUncurryThis({}.toString),
        stringSlice$2 = functionUncurryThis("".slice), classofRaw = function (it) {
            return stringSlice$2(toString(it), 8, -1)
        }, TO_STRING_TAG$3 = wellKnownSymbol("toStringTag"), $Object$3 = Object,
        ...
        }, charAt$1 = functionUncurryThis("".charAt), charCodeAt = functionUncurryThis("".charCodeAt),
        stringSlice$1 = functionUncurryThis("".slice), createMethod$3 = function (CONVERT_TO_STRING) {
            return function ($this, pos) {
                var first, second, S = toString_1(requireObjectCoercible($this)), position = toIntegerOrInfinity(pos),
                    size = S.length;
        ...
        }, stringMultibyte = {codeAt: createMethod$3(!1), charAt: createMethod$3(!0)}, WeakMap$1 = global_1.WeakMap,
        weakMapBasicDetection = isCallable(WeakMap$1) && /native code/.test(String(WeakMap$1)),
        documentAll = documentAll_1.all, isObject = documentAll_1.IS_HTMLDDA ? function (it) {
        ...
        })), document$3 = global_1.document, EXISTS$1 = isObject(document$3) && isObject(document$3.createElement),
        ...
        }, objectIsPrototypeOf = functionUncurryThis({}.isPrototypeOf), $Object$2 = Object,
        ...
        }, $TypeError$9 = TypeError, $defineProperty = Object.defineProperty,
        $getOwnPropertyDescriptor$1 = Object.getOwnPropertyDescriptor, ENUMERABLE = "enumerable",
        CONFIGURABLE$1 = "configurable", WRITABLE = "writable",
        ...
        }, objectDefineProperty = {f: f$6}, createPropertyDescriptor = function (bitmap, value) {
        ...
        }, hiddenKeys$1 = {}, OBJECT_ALREADY_INITIALIZED = "Object already initialized", TypeError$2 = global_1.TypeError,
        WeakMap = global_1.WeakMap, set$1, get, has, enforce = function (it) {
    ...
    var internalState = {set: set$1, get: get, has: has, enforce: enforce, getterFor: getterFor},
        $propertyIsEnumerable$1 = {}.propertyIsEnumerable, getOwnPropertyDescriptor$3 = Object.getOwnPropertyDescriptor,
        NASHORN_BUG = getOwnPropertyDescriptor$3 && !$propertyIsEnumerable$1.call({1: 2}, 1),
        f$5 = NASHORN_BUG ? function (V) {
            var descriptor = getOwnPropertyDescriptor$3(this, V);
            return !!descriptor && descriptor.enumerable
        } : $propertyIsEnumerable$1, objectPropertyIsEnumerable = {f: f$5}, $Object$1 = Object,
        split = functionUncurryThis("".split), indexedObject = fails((function () {
            return !$Object$1("z").propertyIsEnumerable(0)
        })) ? function (it) {
            return "String" == classofRaw(it) ? split(it, "") : $Object$1(it)
        } : $Object$1, toIndexedObject = function (it) {
        ...
        }, objectGetOwnPropertyDescriptor = {f: f$4}, FunctionPrototype$1 = Function.prototype,
        getDescriptor = descriptors && Object.getOwnPropertyDescriptor,
        EXISTS = hasOwnProperty_1(FunctionPrototype$1, "name"), PROPER = EXISTS && "something" === function () {
        }.name,
        CONFIGURABLE = EXISTS && (!descriptors || descriptors && getDescriptor(FunctionPrototype$1, "name").configurable),
        functionName = {EXISTS: EXISTS, PROPER: PROPER, CONFIGURABLE: CONFIGURABLE},
    ...
    var inspectSource = sharedStore.inspectSource, makeBuiltIn_1 = createCommonjsModule((function (module) {
            var CONFIGURABLE_FUNCTION_NAME = functionName.CONFIGURABLE, enforceInternalState = internalState.enforce,
                getInternalState = internalState.get, defineProperty = Object.defineProperty,
                ...
                makeBuiltIn = module.exports = function (value, name, options) {
                    "Symbol(" === String(name).slice(0, 7) && (name = "[" + String(name).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"), options && options.getter && (name = "get " + name), options && options.setter && (name = "set " + name), (!hasOwnProperty_1(value, "name") || CONFIGURABLE_FUNCTION_NAME && value.name !== name) && (descriptors ? defineProperty(value, "name", {
                        value: name,
                        configurable: !0
                    }) : value.name = name), CONFIGURABLE_LENGTH && options && hasOwnProperty_1(options, "arity") && value.length !== options.arity && defineProperty(value, "length", {value: options.arity});
                    try {
                        options && hasOwnProperty_1(options, "constructor") && options.constructor ? descriptors && defineProperty(value, "prototype", {writable: !1}) : value.prototype && (value.prototype = void 0)
                    } catch (error) {
                    }
            ...
            if (isCallable(value) && makeBuiltIn_1(value, name, options), options.global) simple ? O[key] = value : defineGlobalProperty(key, value); else {
                try {
            ...
            return function ($this, el, fromIndex) {
                var value, O = toIndexedObject($this), length = lengthOfArrayLike(O),
        ...
        push$3 = functionUncurryThis([].push), objectKeysInternal = function (object, names) {
        ...
        hiddenKeys = enumBugKeys.concat("length", "prototype"), f$3 = Object.getOwnPropertyNames || function (O) {
            return objectKeysInternal(O, hiddenKeys)
        }, objectGetOwnPropertyNames = {f: f$3}, f$2 = Object.getOwnPropertySymbols, objectGetOwnPropertySymbols = {f: f$2},
        ...
        _export = function (options, source) {
            ...
            if (target = GLOBAL ? global_1 : STATIC ? global_1[TARGET] || defineGlobalProperty(TARGET, {}) : (global_1[TARGET] || {}).prototype) for (key in source) {
            ...
            return O
        }, objectDefineProperties = {f: f$1}, html = getBuiltIn("document", "documentElement"), GT = ">", LT = "<",
        PROTOTYPE = "prototype", SCRIPT = "script", IE_PROTO$1 = sharedKey("IE_PROTO"), EmptyConstructor = function () {
    ...
    var objectCreate = Object.create || function (O, Properties) {
        ...
        }, ITERATOR$5 = wellKnownSymbol("iterator"), BUGGY_SAFARI_ITERATORS$1 = !1, IteratorPrototype$2,
        PrototypeOfArrayIteratorPrototype, arrayIterator;
    ...
    var iteratorsCore = {IteratorPrototype: IteratorPrototype$2, BUGGY_SAFARI_ITERATORS: BUGGY_SAFARI_ITERATORS$1},
        defineProperty$3 = objectDefineProperty.f, TO_STRING_TAG$2 = wellKnownSymbol("toStringTag"),
        setToStringTag = function (target, TAG, STATIC) {
            ...
            return IteratorConstructor.prototype = objectCreate(IteratorPrototype$1, {next: createPropertyDescriptor(+!ENUMERABLE_NEXT, next)}), setToStringTag(IteratorConstructor, TO_STRING_TAG, !1), iterators[TO_STRING_TAG] = returnThis$1, IteratorConstructor
        }, $String = String, $TypeError$8 = TypeError, aPossiblePrototype = function (argument) {
        ...
        }() : void 0), PROPER_FUNCTION_NAME = functionName.PROPER, CONFIGURABLE_FUNCTION_NAME = functionName.CONFIGURABLE,
        ...
        KEYS = "keys", VALUES = "values", ENTRIES = "entries", returnThis = function () {
            ...
            }, FORCED) for (KEY in methods) (BUGGY_SAFARI_ITERATORS || INCORRECT_VALUES_NAME || !(KEY in IterablePrototype)) && defineBuiltIn(IterablePrototype, KEY, methods[KEY]); else _export({
                target: NAME,
                proto: !0,
                forced: BUGGY_SAFARI_ITERATORS || INCORRECT_VALUES_NAME
            }, methods);
            return IterablePrototype[ITERATOR$4] !== defaultIterator && defineBuiltIn(IterablePrototype, ITERATOR$4, defaultIterator, {name: DEFAULT}), iterators[NAME] = defaultIterator, methods
    ...
    iteratorDefine(String, "String", (function (iterated) {
        setInternalState$2(this, {type: STRING_ITERATOR, string: toString_1(iterated), index: 0})
    }), (function () {
    ...
    var functionUncurryThisClause = function (fn) {
        ...
        }, bind$1 = functionUncurryThisClause(functionUncurryThisClause.bind), functionBindContext = function (fn, that) {
        ...
        }, empty = [], construct = getBuiltIn("Reflect", "construct"), constructorRegExp = /^\s*(?:class|function)\b/,
        exec = functionUncurryThis(constructorRegExp.exec), INCORRECT_TO_STRING = !constructorRegExp.exec(noop$1),
    ...
    })) ? isConstructorLegacy : isConstructorModern, createProperty = function (object, key, value) {
    ...
    }, $TypeError$7 = TypeError, getIterator = function (argument, usingIterator) {
        var iteratorMethod = arguments.length < 2 ? getIteratorMethod(argument) : usingIterator;
        if (aCallable(iteratorMethod)) return anObject(functionCall(iteratorMethod, argument));
        throw $TypeError$7(tryToString(argument) + " is not iterable")
    }, $Array$1 = Array, arrayFrom = function (arrayLike) {
        var O = toObject(arrayLike), IS_CONSTRUCTOR = isConstructor(this), argumentsLength = arguments.length,
    ...
    var path = global_1;
    path.Array.from;
    var defineProperty$2 = objectDefineProperty.f, UNSCOPABLES = wellKnownSymbol("unscopables"),
    ...
    }, $includes = arrayIncludes.includes, BROKEN_ON_SPARSE = fails((function () {
        return !Array(1).includes()
    }));
    _export({target: "Array", proto: !0, forced: BROKEN_ON_SPARSE}, {
    ...
    var isArray = Array.isArray || function (argument) {
            ...
            return targetIndex
        }, flattenIntoArray_1 = flattenIntoArray, SPECIES$3 = wellKnownSymbol("species"), $Array = Array,
    ...
    _export({target: "Array", proto: !0}, {
        flat: function () {
            var depthArg = arguments.length ? arguments[0] : void 0, O = toObject(this),
                sourceLen = lengthOfArrayLike(O), A = arraySpeciesCreate(O, 0);
    ...
    var push$2 = functionUncurryThis([].push), createMethod$1 = function (TYPE) {
        var IS_MAP = 1 == TYPE, IS_FILTER = 2 == TYPE, IS_SOME = 3 == TYPE, IS_EVERY = 4 == TYPE,
            IS_FIND_INDEX = 6 == TYPE, IS_FILTER_REJECT = 7 == TYPE, NO_HOLES = 5 == TYPE || IS_FIND_INDEX;
    ...
    var $assign = Object.assign, defineProperty$1 = Object.defineProperty, concat = functionUncurryThis([].concat),
    ...
    var $propertyIsEnumerable = objectPropertyIsEnumerable.f,
        propertyIsEnumerable = functionUncurryThis($propertyIsEnumerable), push$1 = functionUncurryThis([].push),
    ...
    var $Error$1 = Error, replace = functionUncurryThis("".replace), TEST = String($Error$1("zxcasd").stack),
        V8_OR_CHAKRA_STACK_ENTRY = /\n\s*at [^:]*:[^\n]*/, IS_V8_OR_CHAKRA_STACK = V8_OR_CHAKRA_STACK_ENTRY.test(TEST),
        errorStackClear = function (stack, dropEntries) {
            if (IS_V8_OR_CHAKRA_STACK && "string" == typeof stack && !$Error$1.prepareStackTrace) for (; dropEntries--;) stack = replace(stack, V8_OR_CHAKRA_STACK_ENTRY, "");
            return stack
        }, installErrorCause = function (O, options) {
            isObject(options) && "cause" in options && createNonEnumerableProperty(O, "cause", options.cause)
        }, $TypeError$5 = TypeError, Result = function (stopped, result) {
            this.stopped = stopped, this.result = result
        }, ResultPrototype = Result.prototype, iterate = function (iterable, unboundFunction, options) {
            var iterator, iterFn, index, length, result, next, step, that = options && options.that,
                AS_ENTRIES = !(!options || !options.AS_ENTRIES), IS_RECORD = !(!options || !options.IS_RECORD),
                IS_ITERATOR = !(!options || !options.IS_ITERATOR), INTERRUPTED = !(!options || !options.INTERRUPTED),
                fn = functionBindContext(unboundFunction, that), stop = function (condition) {
            ...
            if (IS_RECORD) iterator = iterable.iterator; else if (IS_ITERATOR) iterator = iterable; else {
                ...
                if (isArrayIteratorMethod(iterFn)) {
                    for (index = 0, length = lengthOfArrayLike(iterable); length > index; index++) if ((result = callFn(iterable[index])) && objectIsPrototypeOf(ResultPrototype, result)) return result;
                    return new Result(!1)
                }
        ...
        })), TO_STRING_TAG$1 = wellKnownSymbol("toStringTag"), $Error = Error, push = [].push,
    ...
    objectSetPrototypeOf ? objectSetPrototypeOf($AggregateError, $Error) : copyConstructorProperties($AggregateError, $Error, {name: !0});
    var AggregateErrorPrototype = $AggregateError.prototype = objectCreate($Error.prototype, {
        constructor: createPropertyDescriptor(1, $AggregateError),
        message: createPropertyDescriptor(1, ""),
        name: createPropertyDescriptor(1, "AggregateError")
    });
    _export({global: !0, constructor: !0, arity: 2}, {AggregateError: $AggregateError});
    var defineProperty = objectDefineProperty.f, ARRAY_ITERATOR = "Array Iterator",
        setInternalState$1 = internalState.set, getInternalState = internalState.getterFor(ARRAY_ITERATOR),
    ...
    toStringTagSupport || defineBuiltIn(Object.prototype, "toString", objectToString, {unsafe: !0});
    var engineIsNode = "process" == classofRaw(global_1.process), SPECIES$2 = wellKnownSymbol("species"),
        ...
        }, FunctionPrototype = Function.prototype, apply = FunctionPrototype.apply, call = FunctionPrototype.call,
        functionApply = "object" == typeof Reflect && Reflect.apply || (functionBindNative ? call.bind(apply) : function () {
            return call.apply(apply, arguments)
        }), arraySlice = functionUncurryThis([].slice), $TypeError$2 = TypeError,
        validateArgumentsLength = function (passed, required) {
            if (passed < required) throw $TypeError$2("Not enough arguments");
            return passed
        }, engineIsIos = /(?:ipad|iphone|ipod).*applewebkit/i.test(engineUserAgent), set = global_1.setImmediate,
        clear = global_1.clearImmediate, process$2 = global_1.process, Dispatch = global_1.Dispatch,
        Function$1 = global_1.Function, MessageChannel = global_1.MessageChannel, String$1 = global_1.String,
        counter = 0, queue$1 = {}, ONREADYSTATECHANGE = "onreadystatechange", $location, defer, channel, port;
    try {
    ...
    set && clear || (set = function (handler) {
        ...
        var fn = isCallable(handler) ? handler : Function$1(handler), args = arraySlice(arguments, 1);
    ...
    var queue = Queue, promiseNativeConstructor = global_1.Promise,
    ...
    var SPECIES = wellKnownSymbol("species"), SUBCLASSING = !1,
        ...
        FORCED_PROMISE_CONSTRUCTOR$5 = isForced_1("Promise", (function () {
            ...
            if (!engineV8Version || engineV8Version < 51 || !/native code/.test(PROMISE_CONSTRUCTOR_SOURCE)) {
                ...
                if ((promise.constructor = {})[SPECIES] = FakePromise, !(SUBCLASSING = promise.then((function () {
                })) instanceof FakePromise)) return !0
            }
        ...
        }, newPromiseCapability$1 = {f: f}, task = task$1.set, PROMISE = "Promise",
        ...
        getInternalPromiseState = internalState.getterFor(PROMISE), setInternalState = internalState.set,
        NativePromisePrototype$2 = promiseNativeConstructor && promiseNativeConstructor.prototype,
        PromiseConstructor = promiseNativeConstructor, PromisePrototype = NativePromisePrototype$2,
        ...
        isThenable = function (it) {
            ...
            var result, then, exited, value = state.value, ok = state.state == FULFILLED,
                handler = ok ? reaction.ok : reaction.fail, resolve = reaction.resolve, reject = reaction.reject,
    ...
    }, {Promise: PromiseConstructor}), setToStringTag(PromiseConstructor, PROMISE, !1), setSpecies(PROMISE);
    ...
    _export({target: "Promise", stat: !0, forced: promiseStaticsIncorrectIteration}, {
    ...
    if (_export({
        ...
        NativePromisePrototype$1.catch !== method$1 && defineBuiltIn(NativePromisePrototype$1, "catch", method$1, {unsafe: !0})
    }
    _export({target: "Promise", stat: !0, forced: promiseStaticsIncorrectIteration}, {
        race: function (iterable) {
            var C = this, capability = newPromiseCapability$1.f(C), reject = capability.reject,
    ...
    _export({target: "Promise", stat: !0, forced: FORCED_PROMISE_CONSTRUCTOR$1}, {
        reject: function (r) {
    ...
    _export({target: "Promise", stat: !0}, {
        any: function (iterable) {
            var C = this, AggregateError = getBuiltIn("AggregateError"), capability = newPromiseCapability$1.f(C),
                resolve = capability.resolve, reject = capability.reject, result = perform((function () {
                    var promiseResolve = aCallable(C.resolve), errors = [], counter = 0, remaining = 1,
                        alreadyResolved = !1;
                    iterate(iterable, (function (promise) {
    ...
    var domIterables = {
        ...
        ITERATOR = wellKnownSymbol("iterator"), TO_STRING_TAG = wellKnownSymbol("toStringTag"),
        ArrayValues = es_array_iterator.values, handlePrototype = function (CollectionPrototype, COLLECTION_NAME) {
    ...
    var MATCH$1 = wellKnownSymbol("match"), isRegexp = function (it) {
        ...
        nativeStartsWith = functionUncurryThisClause("".startsWith), stringSlice = functionUncurryThisClause("".slice),
        min = Math.min, CORRECT_IS_REGEXP_LOGIC = correctIsRegexpLogic("startsWith"),
        ...
        return _createClass(Connection, [{
            ...
            key: "sendMessage", value: function (message) {
                var _this = this, payload = message.payload(), csrfToken = getCsrfToken(),
                    socketId = this.getSocketId(), appUrl = window.livewire_app_url;
                if (this.shouldUseLocalePrefix(payload) && (appUrl = "".concat(appUrl, "/").concat(payload.fingerprint.locale)), window.__testing_request_interceptor) return window.__testing_request_interceptor(payload, this);
                fetch("".concat(appUrl, "/livewire/message/").concat(payload.fingerprint.name), {
                    method: "POST",
            ...
            key: "shouldUseLocalePrefix", value: function (payload) {
                var path = payload.fingerprint.path, locale = payload.fingerprint.locale;
