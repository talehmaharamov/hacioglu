...
<script src="{{ asset('frontend/vendors/jquery-migrate/jquery-migrate.min.js')}}"></script>
...
<script src="{{ asset('frontend/vendors/extra-scripts/jquery.paroller.min.js')}}"></script>
<script src="{{ asset('frontend/vendors/language-switcher/jquery.polyglot.language.switcher.js')}}"></script>
<script src="{{ asset('frontend/vendors/extra-scripts/jquery-sidebar-content.js')}}"></script>
<script src="{{ asset('frontend/vendors/fancybox/jquery.fancybox.js')}}"></script>
